...
public final class QueryUtils {
    ...
    public static List<Article> fetchNewsData(String requestUrl) {
        ...
        List<Article> news = extractNews(jsonResponse);
    ...
    private static List<Article> extractNews(String newsJson) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++){
                ...
                Article article = new Article(title, section, author, publicationDate, url, thumbnailUrl);
                news.add(article);
            }
